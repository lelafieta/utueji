...
class MyCampaignSettingsPage extends StatefulWidget {
  final CampaignEntity campaign;
  MyCampaignSettingsPage({super.key, required this.campaign});

  @override
  State<MyCampaignSettingsPage> createState() => _MyCampaignSettingsPageState();
}

class _MyCampaignSettingsPageState extends State<MyCampaignSettingsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: false,
        title: const Text('Configurações da Campanha'),
        actions: [
          TextButton(
            onPressed: () {},
            child: Text(
