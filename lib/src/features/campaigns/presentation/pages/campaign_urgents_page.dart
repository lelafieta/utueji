...
class CampaignUrgentsPage extends StatefulWidget {
  const CampaignUrgentsPage({super.key});

  @override
  State<CampaignUrgentsPage> createState() => _CampaignUrgentsPageState();
}

class _CampaignUrgentsPageState extends State<CampaignUrgentsPage> {
