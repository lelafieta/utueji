...
class _CategoryRemoteDataSource implements CategoryRemoteDataSource {
  _CategoryRemoteDataSource(
    ...
    baseUrl ??= 'http://your-api-url.com/categories';
  }
  ...
  Future<CategoryModel> createCategory(
      CreateCategoryDto createCategoryDto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(createCategoryDto.toJson());
  ...
  Future<CategoryModel> updateCategory(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateCategoryDto.toJson());
    final _options = _setStreamType<CategoryModel>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
